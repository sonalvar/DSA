...
#
# The insert method should take an integer index and a value as parameters and insert a new node with the given value
# at the specified index in the linked list.
#
# If the index is out of bounds, the method should return False. If the new node is successfully inserted,
